...
| 터렛 상하 | SG90(GPIO23) — 연결 시 **80°**, 범위 **60°~110°**, D-Pad ↑/↓ **1°** 연속(홀드), 3초 무입력 detach |
...
| D-Pad ↑ / ↓ | 터렛 **상하** 1° 연속 (**60°~110°**, 누르는 동안, 연결 시 80°) |
| Start | 좌우 90° / 상하 80° |
...
- **D-Pad ↑/↓ 홀드**: 약 50ms마다 **1°** 씩 연속 이동 (`PITCH_STEP_DEG`, `PITCH_HOLD_INTERVAL_MS`)
- **범위**: 60°~110°
- **슬루**: 목표까지 부드럽게 이동
- **3초 무입력**(슬루 완료 후): detach
- **Start**: 좌우 90° / 상하 80°
